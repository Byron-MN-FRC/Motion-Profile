...
public class Robot extends IterativeRobot {
	...
	TalonSRX _follower = new TalonSRX(2);
	...
	public void disabledInit() {
		...
		_talon.config_kF(0, 0.12, Constants.kTimeoutMs);
		_talon.config_kP(0, 0.24, Constants.kTimeoutMs);
		_talon.config_kI(0, 0.00005, Constants.kTimeoutMs);
	...
	public void teleopPeriodic() {
		...
		if (btns[5] == false) {
			...
			_follower.set(ControlMode.Follower, 1);
